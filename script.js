...
saveBtn.addEventListener("click", () => {
  localStorage.setItem("danceMemoryCoachLists", JSON.stringify(lists));
  currentStep.textContent = "💾 Lista guardada";
});

window.addEventListener("load", () => {
  const saved = localStorage.getItem("danceMemoryCoachLists");
  if (saved) {
